  ...
  :TWindow(p,t1)
{
  ...
  int txt_height = TPenBase::getHeightOfTextFromWidth(&getDefaultFont(), text, txt_width);
...
TMessageBox::adjust()
{
  placeWindow(_placement, getParent());
}
...
toad::messageBox(TWindow* parent, 
           ...
           unsigned long type,
           TBitmap *bmp,
           TWindow::EWindowPlacement placement)
{
