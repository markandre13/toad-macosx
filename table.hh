...
#ifndef __TOAD_TABLE_HH
#define __TOAD_TABLE_HH 1
...
struct TTableEvent
{
  ...
  TPen *pen;	      // might be NULL
  /**
   * Might be NULL.
   * Position will be relative to field/header instead of the window.
   */
  const TMouseEvent *mouse; // might be NULL
  const TKeyEvent *key;     // might be NULL
